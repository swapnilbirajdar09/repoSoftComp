 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'Bizmo Technologies');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'MEA');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'MEA Enrolled Member List');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "Powered by Bizmo Technologies\nwww.Bizmo-Tech.com");
