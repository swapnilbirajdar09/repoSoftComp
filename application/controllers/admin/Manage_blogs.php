...
class Manage_blogs extends CI_Controller {
    ...
    public function index() {
        ...
        $data['all_portfolios']=$this->blog_model->getAllBlogs();
    ...
    public function addPortfolio(){
        ...
        $result = $this->blog_model->addPortfolio($data);
...
public function markPortfolio(){
    extract($_GET);
    if(isset($portfolio_id) && $portfolio_id!=''){
        $result = $this->blog_model->markPortfolio($portfolio_id);
...
public function unmarkPortfolio(){
    extract($_GET);
    if(isset($portfolio_id) && $portfolio_id!=''){
        $result = $this->blog_model->unmarkPortfolio($portfolio_id);
...
public function portfolio($url=''){
    ...
    $data['categories']=$this->blog_model->getAllCategories();
    $data['portfolioDetail']=$this->blog_model->getPortfolioDetail($portfolio_id);
    $this->load->view('includes/header');
