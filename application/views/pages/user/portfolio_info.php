              ...
              <div class="swiper-wrapper">
                ...
                if($portfolioDetail[0]['portfolio_images']!='' && $portfolioDetail[0]['portfolio_images']!='[""]'){
                  foreach (json_decode($portfolioDetail[0]['portfolio_images']) as $key) {
                    ...
                    <img src="'.base_url().$key.'" alt="" class="w3-hide-small" style="width:100%;height:600px">
                    <img src="'.base_url().$key.'" alt="" class="w3-hide-large" style="width:100%;height:200px">
                    </div>';
                  }
                }
                ?>
          ...
          <div class="row">
            ...
            <div class="col-md-4 col-md-offset-2 wow fadeIn">
              <ul class="list-style-8">
                <li class="text-uppercase text-extra-dark-gray"><span class="display-block text-extra-small text-medium-gray">Client</span><?php if($portfolioDetail[0]['client_name']==''){ echo '<span class="text-light-gray">Not Available</span>'; }else{ echo $portfolioDetail[0]['client_name']; } ?></li>
