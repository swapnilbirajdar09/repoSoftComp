...
<section class="wow fadeIn parallax" data-stellar-background-ratio="0.5" style="background-image:url('<?php echo base_url(); ?>assets/images/contact-us-classic-1-1000x700.jpg');padding:80px 0">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12 extra-small-screen display-table page-title-large">
                <div class="display-table-cell vertical-align-middle text-center">
                    <!-- start page title-->
                    <h1 class="text-white text-font-sec text-medium letter-spacing-minus-1">Contact us</h1>
                </div>
            </div>
        </div>
    </div>
