                            ...
                            <form id="add_company_profile">    
                                ...
                                <div class="w3-col l12 w3-margin-top">
                                    ...
                                    <div class="col-lg-6 w3-margin-bottom">
                                        ...
                                        <input type="text" name="company_email" value="<?php echo $company_details[0]['company_email']; ?>"  class="w3-input" placeholder="Enter Company Email Here" required>
                                    </div>
                                </div>
                                <div class="w3-col l12">
                                    <div class="col-lg-6 w3-margin-bottom">
                                  ...
                                  <form id="add_company_address">    
                                    <div class="w3-col l12 s12 m12 w3-small">
                                        <div class="w3-col l3 ">
                                            ...
                                            <select class="w3-input w3-border control w3-text-grey" name="office_type[]" id="mc-caste" value="<?php echo $company_details[0]['company_email']; ?>" required>
                                        ...
                                        <div class="w3-col l3 ">
                                            ...
                                            <textarea class="w3-input" name="office_address[]" placeholder="Enter Office Address Here..." rows="4"></textarea>
                                        </div>
                                        <div class="w3-col l12" id="addedmore_Div"></div>
                                        <div class="w3-col l12 w3-margin-bottom">
                                            <a id="add_more" title="Add new Item" class="btn w3-text-red add_moreProduct w3-small w3-right w3-margin-top"><b>Add More<i class="fa fa-plus"></i></b>
                                            </a>
                                        </div>
                                        <div class="col-lg-12 w3-center w3-margin-bottom w3-padding-top" id="archSubmit">
    ...
    <option value="Branch">Branch</option>\n\
                                ...
                                <div class="w3-col l3 ">\n\
                              <label>Phone Number :</label>\n\
                               <input type="number" name="office_number[]" class="w3-input" placeholder="Enter Company Name Here" required>\n\
                               </div>\n\
                                <div class="w3-col l3 ">\n\
                              <label>Office Email:</label>\n\
                               <input type="email" name="office_email[]" class="w3-input" placeholder="Enter Company Name Here" required>\n\
                               </div>\n\
                                <div class="w3-col l3 ">\n\
                              <label>Office Address:</label>\n\
                               <textarea class="w3-input" name="office_address[]" placeholder="Enter Client Comments Here..." rows="4"></textarea>\n\
                               </div>\n\
      ...
      <script>
          $(function () {
              $("#add_company_profile").submit(function () {
                 ...
                 // alert(dataString);
                   $('#addofficedetails').html('<span class="w3-card w3-padding-small w3-margin-bottom w3-round"><i class="fa fa-spinner fa-spin w3-large"></i> <b>Company Address Add. Please wait...</b></span>');
                  $.ajax({
                      type: "POST",
